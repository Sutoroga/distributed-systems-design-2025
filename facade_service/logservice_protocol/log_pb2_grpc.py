...
import logservice_protocol.log_pb2 as log__pb2
...
class LogServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.LogMessage = channel.unary_unary(
                '/logservice_protocol.LogService/LogMessage',
                request_serializer=log__pb2.LogRequest.SerializeToString,
                response_deserializer=log__pb2.LogResponse.FromString,
                _registered_method=True)
        self.GetMessages = channel.unary_unary(
                '/logservice_protocol.LogService/GetMessages',
                request_serializer=log__pb2.Empty.SerializeToString,
                response_deserializer=log__pb2.Messages.FromString,
                _registered_method=True)
...
def add_LogServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'GetMessages': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=log__pb2.Empty.FromString,
                    response_serializer=log__pb2.Messages.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
            'logservice_protocol.LogService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('logservice_protocol.LogService', rpc_method_handlers)
...
class LogService(object):
    ...
    def GetMessages(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/logservice_protocol.LogService/GetMessages',
            log__pb2.Empty.SerializeToString,
            log__pb2.Messages.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
